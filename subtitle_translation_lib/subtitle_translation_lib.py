...
def add_subtitles_with_ffmpeg(video_path, subtitle_file, output_path):
    # Modify ffmpeg command to position subtitles at the bottom
    command = [
        "ffmpeg", "-i", video_path, "-vf", f"subtitles={subtitle_file}:force_style='Alignment=2'",  # Alignment 2 is bottom center
